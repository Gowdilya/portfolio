            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Link to="/tracking&traceability">
                  <ListItem
                    button
                    key={"Tracking & Traceability"}
                    selected={location.pathname === "/tracking&traceability"}
                  >
                    <ListItemIcon>
              ...
              <AccordionDetails>
                <Link to="/csv-viewer">
                  <ListItem
                    button
                    key={"CSV Viewer"}
                    selected={location.pathname === "/csv-viewer"}
                  >
                    <ListItemIcon>
              ...
              <AccordionDetails>
                <Link to="/csv-grapher">
                  <ListItem
                    button
                    key={"CSV Grapher"}
                    selected={location.pathname === "/csv-grapher"}
                  >
                    <ListItemIcon>
              ...
              <AccordionDetails>
                <Link to="/histogram">
                  <ListItem
                    button
                    key={"Histogram"}
                    selected={location.pathname === "/histogram"}
                  >
                    <ListItemIcon>
